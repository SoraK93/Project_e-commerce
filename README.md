...
npm install
```
To run server at: LocalHost: 43576
```
npm start
```
...
- Setup user based database scehma giving access to specific tables on user level (isolating each users access to database)
